...
Para el uso de \textit{notebooks} se necesita crear un fichero \code{api\_key.txt}, en el directorio \textit{scripts and notebooks} que contiene la clave de acceso a la API.
...
\begin{itemize}
	...
	\item \code{DEBUG}: define si está activado el modo \textit{debug} de la aplicación.
\end{itemize}
